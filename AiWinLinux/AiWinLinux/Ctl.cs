...
namespace AiWinLinux
{
    public class Ctl
    {
        ...
        /// <returns></returns>
        public static JsonMessage CameraOne(string crossingId, string cameraOne)
        {
        ...
        /// <returns></returns>
        public static JsonMessage CameraTwo(string crossingId, string cameraTwo)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage CameraThree(string crossingId, string cameraThree)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage Fot(string crossingId, string fot)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage Router(string crossingId, string router)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage Fan(string crossingId, string fan)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage Acb(string crossingId, string acb)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage CoolingTemp(string crossingId, string coolingTemp)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage SwitchOnSum(string crossingId, string switchOnSum)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage AliveTime(string crossingId, string aliveTime)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
        ...
        /// <returns></returns>
        public static JsonMessage ThresholdVoltage(string crossingId, string thresholdVoltage)
        {
            var msg = new JsonMessage { Success = false, Message = "parameter error" };
